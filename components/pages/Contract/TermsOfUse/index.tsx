...
const TermsOfUse = () => {
  return (
    <section className="container max-w-[1255px] mt-32 mb-20">
      <div className="w-full prose prose-lg">
        <h1>Kullanım Şartları</h1>
        <ul className="flex items-center w-full justify-start gap-2">
          <Link
            href="/sozlesmeler/gizlilik-politikasi"
            className="px-6 py-2 rounded-full no-underline cursor-pointer border border-gray-200 transition hover:bg-gray-100 font-medium"
          >
            Gizlilik Politikası
          </Link>
          <Link
          ...
          <Link
            ...
            className="px-6 py-2 rounded-full no-underline cursor-pointer transition bg-primary text-white font-medium"
          >
            Kullanım Şartları
          </Link>
          <Link
        ...
        <p>
          Sevgili ziyaretçimiz, lütfen https://www.takipkira.com/ web sitemizi
        ...
        <p>
          https://www.takipkira.com/ web sitesi Kira Takip tarafından
        ...
        <p>
          Kira Takip olarak, sunacağımız hizmetlerin kapsamını ve niteliğini,
          yasalar çerçevesinde belirlemekte tamamen serbest olup; hizmetlere
          ilişkin yapacağımız değişiklikler, SİTE’de yayınlanmakla yürürlüğe
          girmiş sayılacaktır.
        </p>
        <h2>Telif Hakları</h2>
        <p>
          ...
          “içerik” olarak anılacaktır) Kira Takip olup, tüm hakları saklıdır.
          Yazılı izin olmaksızın site içeriğinin çoğaltılması veya kopyalanması
          kesinlikle yasaktır.
        </p>
        <h2>Genel Hükümler</h2>
        <p>
          Kullanıcıların tamamı, SİTE’yi yalnızca hukuka uygun ve şahsi
          amaçlarla kullanacaklarını ve üçüncü kişinin haklarına tecavüz teşkil
          edecek nitelikteki herhangi bir faaliyette bulunmayacağını taahhüt
          eder. SİTE dâhilinde yaptıkları işlem ve eylemlerindeki, hukuki ve
          cezai sorumlulukları kendilerine aittir. İşbu iş ve eylemler
          sebebiyle, üçüncü kişilerin uğradıkları veya uğrayabilecekleri
          zararlardan dolayı SİTE’nin doğrudan ve/veya dolaylı hiçbir
          sorumluluğu yoktur. SİTE’de mevcut bilgilerin doğruluk ve güncelliğini
          sağlamak için elimizden geleni yapmaktayız. Lakin gösterdiğimiz çabaya
          rağmen, bu bilgiler, fiili değişikliklerin gerisinde kalabilir,
          birtakım farklılıklar olabilir. Bu sebeple, site içerisinde yer alan
        ...
        <p>
          ...
          (hyperlink) bulunabilir. SİTE, işlevsellik yalnızca bu sitelere
          ulaşımı sağlamakta olup, içerikleri ile ilgili hiçbir sorumluluk kabul
          etmemekteyiz. SİTE’yi virüslerden temizlenmiş tutmak konusunda
          elimizden geleni yapsak da, virüslerin tamamen bulunmadığı garantisini
          vermemekteyiz. Bu nedenle veri indirirken, virüslere karşı gerekli
          önlemi almak, kullanıcıların sorumluluğundadır. Virüs vb. kötü amaçlı
          programlar, kodlar veya materyallerin sebep olabileceği zararlardan
        ...
        <p>
          ...
          sitenin hizmetlerine veya herhangi bir bölümüne olan erişiminizi
        ...
        <p>
          ...
          Cumhuriyeti yasaları uygulanır; Kayseri Adliyesi Mahkemeleri ve İcra

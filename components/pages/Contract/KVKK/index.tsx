  ...
  return (
    <section className="container max-w-[1255px] mt-32 mb-20">
      <div className="w-full prose prose-lg">
        ...
        <p>
          Biz, Kira Takip, veri sorumlusu olarak, bu gizlilik ve kişisel
        ...
        <p>
          Yukarıda sayılan haklarınızı kullanmak üzere bilgi@takipkira.com
        ...
        <p>
          ...
          ayrıntılı bilgi için bizimle bilgi@takipkira.com e-mail adresi
